...
const FillTexUser1 = () => {
  const [filltextusers, setfilltextusers] = useState(allComments)
  return (
    <div>
      <Table filltextusers={filltextusers}/>
      <Cards filltextusers={filltextusers}/>
    </div>
  )
}

export default FillTexUser1
